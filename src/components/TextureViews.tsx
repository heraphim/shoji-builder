...
import { BEAMS, BEAM_LENGTH_MM, SECTIONS } from "../lib/testBeams";

/**
 * The Textures tab's four views, and the test pieces in them.
 *
 * The pieces themselves are `lib/testBeams.ts` — four sticks at the four
 * sections this project cuts, which is what a wood texture is judged on and why
 * it is not a sphere. They moved out of this file when the Texture Generator
 * came to want the same four.
 *
